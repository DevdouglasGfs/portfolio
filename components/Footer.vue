...
<template>
    <footer
        class="flex flex-col gap-8 w-full max-w-full md:landscape:grid md:landscape:grid-cols-2 bg-secundary-700 px-16 py-6">
        <div class="flex flex-col gap-6 md:landscape:col-span-1">
            <hgroup class="flex flex-col gap-2">
                <h6 class="title leading-relaxed">Douglas S. Silva - Portfólio</h6>
                <p class="text-sm lg:text-base capitalize leading-relaxed">Copyright © 2024<br />Todos os direitos autorais
                    reservados</p>
            </hgroup>
        ...
        <NuxtImg class="self-stretch object-scale-down h-[300px] lg:h-[400px] md:landscape:col-span-1 w-full"
            src="/assets/images/characters/roboto.png" placeholder alt="" />
    </footer>
</template>