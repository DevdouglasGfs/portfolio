...
const certiticationsList: Ref<Array<CertificationDTO> | null> = useFetch<
  Array<CertificationDTO>
>("/api/certifications").data;
...
<template>
  ...
  >
    <div class="size-max">
      <Icon class="title text-primary-500" name="mdi:certificate-outline" />
    </div>
    <svg
      class="absolute -z-10 isolate top-16 left-0 max-w-full overflow-x-hidden"
      width="650"
      height="600"
      viewBox="0 0 650 300"
      fill="none"
    ...
    <div class="flex flex-col gap-6 lg:gap-8 w-full">
      ...
      <ul class="flex relative flex-col gap-6 self-stretch">
        <li v-for="certification in certiticationsList" class="w-full">
          <Certification
            :title="certification.title"
            :started="certification.started"
            :description="certification.description"
            :finished="certification.finished"
